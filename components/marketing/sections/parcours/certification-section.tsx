...
import { Award, CheckCircle2, Share2, TrendingUp } from "lucide-react"
import { LearningPath } from "@/lib/supabase/types"

interface ParcoursCertificationProps {
  learningPath: LearningPath
}

export function ParcoursCertification({ learningPath }: ParcoursCertificationProps) {
  ...
  const features = [
    {
      ...
      description: `Obtenez le certificat « ${learningPath.title} » à la complétion du parcours.`,
      color: "from-indigo-500 to-purple-500",
    },
    {
      icon: CheckCircle2,
      title: "Reconnaissance",
      description: "Délivré par EduPro et l'organisation partenaire.",
    ...
    {
      icon: TrendingUp,
      title: "Valorise votre profil",
      description: "Démontrez vos compétences acquises auprès des employeurs et partenaires.",
      ...
      <Container className="relative">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg text-slate-600">
            Validez vos acquis avec une certification reconnue à la fin de votre parcours
          </p>
        </div>
            ...
            <div className="relative overflow-hidden rounded-3xl border-2 border-slate-200 bg-white p-8 shadow-xl">
              ...
              <div className="relative space-y-6">
                ...
                <div>
                  ...
                  <h3 className="mt-2 text-2xl font-bold text-slate-900">{learningPath.title}</h3>
                </div>
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-sm text-slate-600">Ce certificat atteste que</p>
                  <p className="mt-1 text-lg font-bold text-slate-900">[Nom de l'apprenant]</p>
                  <p className="mt-3 text-sm text-slate-600">a complété avec succès ce parcours de formation</p>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs text-slate-500">Délivré par</p>
                    <p className="mt-1 text-sm font-semibold text-slate-900">EduPro</p>
                  </div>
