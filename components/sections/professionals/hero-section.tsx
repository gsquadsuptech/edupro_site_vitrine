...
import eduproFormateur from "@/assets/images/edupro-formateur.png"
import eduproEntrepriseImage from "@/assets/images/edupro-entreprise3.png"
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-2 text-sm">
                                <span className="text-muted-foreground">{t("learn")}</span>
