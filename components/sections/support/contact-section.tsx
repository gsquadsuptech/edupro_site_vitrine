                ...
                <div className="grid gap-6 md:grid-cols-3">
                    {contactOptions.map((option, index) => (
                        <Card key={index} className="border border-border bg-card p-8 text-center transition-all hover:shadow-lg">
                            <div className={`mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl ${option.bgColor}`}>
                            ...
                            <Button asChild variant="outline" className="w-full bg-transparent hover:bg-muted">
