        ...
        <section className="bg-muted/30 py-20 md:py-32">
            <Container>
                <div className="mb-16 text-center">
                    <h2 className="mb-4 text-3xl font-bold md:text-4xl">Les bonnes personnes, au bon moment</h2>
                    <p className="text-lg text-muted-foreground">Équipe Fondatrice</p>
                </div>
                ...
                <div className="mt-16 rounded-lg border border-border bg-card p-8">
                    <h3 className="mb-6 text-xl font-bold">Advisors & Soutiens</h3>
                    <div className="grid gap-4 md:grid-cols-2">
                        <div className="text-sm text-muted-foreground">À compléter avec vrais profils et soutiens</div>
                    </div>
                </div>
            </Container>
        </section>
