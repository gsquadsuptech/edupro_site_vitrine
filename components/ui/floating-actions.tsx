...
import { ArrowUp, BookOpen, Moon, Sun } from "lucide-react"
...
export function FloatingActions() {
    ...
    // Calculate generic circle properties
    const radius = 20
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-center">
            ...
            {mounted && (
                ...
                >
                    <Button
                        size="icon"
                        variant="secondary"
                        className="h-12 w-12 rounded-full shadow-lg relative group border"
                        onClick={toggleTheme}
                    >
                        {theme === 'dark' ? (
            ...
            >
                <Button
                    size="icon"
                    className="h-12 w-12 rounded-full bg-indigo-600 hover:bg-indigo-700 shadow-lg relative group"
                    onClick={() => alert("Chatbot Guide: Implementation in coming!")}
                >
            ...
            >
                <Button
                    size="icon"
                    className="h-12 w-12 rounded-full bg-[#25D366] hover:bg-[#128C7E] shadow-lg relative group"
